...
import (
	...
	"filippo.io/mldsa"
	"filippo.io/mldsa/internal/cryptotest/wycheproof"
	internalmldsa "filippo.io/mldsa/internal/fips140/mldsa"
...
func runSignTest(t *testing.T, priv *mldsa.PrivateKey, tv wycheproof.MlDsaSignTestVector, shouldPass bool) {
	...
	if μ != nil {
		sigMu, errMu = priv.SignDeterministic(μ, mldsacrypto.MLDSAMu)
	}
